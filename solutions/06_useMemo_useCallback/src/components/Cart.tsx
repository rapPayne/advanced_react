import { CSSProperties, ReactElement, useCallback, useContext, useMemo, useState } from 'react';
...
export const Cart = ({ cart, changeCartItem, removeFromCart }: Props): ReactElement => {
  ...
  const [pan, setPan] = useState<string>(user?.creditCard?.pan ?? "");
